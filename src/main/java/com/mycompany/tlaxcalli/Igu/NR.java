...
public class NR extends javax.swing.JFrame {
    ...
    private void b_guardarVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_guardarVActionPerformed
        ...
        int idEmpleado = 0;
        if (itemSeleccionado instanceof com.mycompany.tlaxcalli.Logica.EmpleadoItem) {
            idEmpleado = ((com.mycompany.tlaxcalli.Logica.EmpleadoItem) itemSeleccionado).getId();
        }
        ...
        // 5. LLAMAR AL DAO
        com.mycompany.tlaxcalli.Persistencia.VentasDAO dao = new com.mycompany.tlaxcalli.Persistencia.VentasDAO();
    ...
    private void BoxRepartidorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BoxRepartidorActionPerformed
        ...
        // INSTANCIAS DAO
        com.mycompany.tlaxcalli.Persistencia.MolinoDAO molinoDao = new com.mycompany.tlaxcalli.Persistencia.MolinoDAO();
        com.mycompany.tlaxcalli.Persistencia.VentasDAO ventasDao = new com.mycompany.tlaxcalli.Persistencia.VentasDAO();
    ...
    private void cb_productoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_productoActionPerformed
        ...
        com.mycompany.tlaxcalli.Logica.ProductoItem item = 
            (com.mycompany.tlaxcalli.Logica.ProductoItem) cb_producto.getSelectedItem();
        t_cantidad.setText("");
        t_precio.setText("");
        t_detalle.setText("");
    ...
    private void cb_gastosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_gastosActionPerformed
        ...
        com.mycompany.tlaxcalli.Logica.GastoItem item = 
            (com.mycompany.tlaxcalli.Logica.GastoItem) cb_gastos.getSelectedItem();
    ...
    private void cargarEmpleados() {
        com.mycompany.tlaxcalli.Persistencia.EmpleadosDAO dao = new com.mycompany.tlaxcalli.Persistencia.EmpleadosDAO();
        javax.swing.table.DefaultTableModel modelo = dao.consultarEmpleados();
        
        BoxRepartidor.addItem(new com.mycompany.tlaxcalli.Logica.EmpleadoItem(0, "Seleccione...")); 
        ...
        for (int i = 0; i < modelo.getRowCount(); i++) {
            ...
            BoxRepartidor.addItem(new com.mycompany.tlaxcalli.Logica.EmpleadoItem(id, nombre));
        }
    }
    ...
    private void cargarComboProductos() {
        com.mycompany.tlaxcalli.Persistencia.Cconection con = new com.mycompany.tlaxcalli.Persistencia.Cconection();
        cb_producto.addItem(new com.mycompany.tlaxcalli.Logica.ProductoItem(0, "Seleccionar...", 0, false));
        try {
            ...
            while(rs.next()) {
                ...
                com.mycompany.tlaxcalli.Logica.ProductoItem item = new com.mycompany.tlaxcalli.Logica.ProductoItem(
    ...
    private void cargarComboGastos() {
        cb_gastos.addItem(new com.mycompany.tlaxcalli.Logica.GastoItem(0, "Seleccionar...", false));
        try {
            java.sql.Connection c = new com.mycompany.tlaxcalli.Persistencia.Cconection().establecerConexion();
            String sql = "SELECT * FROM Cat_Gastos"; 
            java.sql.PreparedStatement ps = c.prepareStatement(sql);
            java.sql.ResultSet rs = ps.executeQuery();
            //cb_gastos.addItem("Seleccionar...");
            while(rs.next()) {
                cb_gastos.addItem(new com.mycompany.tlaxcalli.Logica.GastoItem(
                    rs.getInt("Id_tipo"),
                    rs.getString("Nombre"),
